...
class com_sppagebuilderInstallerScript
{
    ...
    */
    ...
    public function postflight($type, $parent) {
        ...
        <link href="<?php echo JURI::base() . 'components/com_sppagebuilder/assets/css/font-awesome-5.min.css'; ?>" rel="stylesheet">
        <link href="<?php echo JURI::base() . 'components/com_sppagebuilder/assets/css/font-awesome-v4-shims.css'; ?>" rel="stylesheet">
        ...
        <div class="sppb-installation-wrap row-fluid">
            ...
            <div class="sppb-installation-right span8">
                <div class="sppb-installation-texts">
                    <h2>SP Page Builder Pro <span>Version: 3.7.0</span></h2>
                ...
                <div class="sppb-installation-footer">
                    <div class="pagebuilder-links">
                        ...
                        <a class="btn btn-sppb-custom" href="https://www.youtube.com/playlist?list=PL43bbfiC0wjhDKWuY0Iz3_AG8GqmrnM0z" target="_blank"><span class="fa fa-play-circle-o"></span> Videos</a>
