...
class SppagebuilderAddonImage_layouts extends SppagebuilderAddons{
	...
	public function render() {
		...
		if($image_preset_thumb === 'inline'){
			...
			$output .= '<img class="sppb-img-responsive'.$image_strech.''.($placeholder ? ' sppb-element-lazy' : '').'" src="' . ($placeholder ? $placeholder : $image_link) . '" alt="'. $alt_text .'" '.($placeholder ? 'data-large="'.$image_link.'"' : '').' '.($dimension ? $dimension : '').' loading="lazy">';
