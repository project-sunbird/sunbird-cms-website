	...
	<div class="well">
		<div class="row">
			<div class="col-xs-12 col-sm-8">
				<div class="row">
					<div class="mediaLabel col-xs-12">
						<label for="folder"><?php echo JText::_('COM_MEDIA_DIRECTORY') ?></label>
					</div>
					<div class="mediaInput col-xs-12">
						<div class="row">
							<div class="col-xs-8">
								<?php echo $this->folderList; ?>
							</div>
							<div class="col-xs-4">
								<button class="btn btn-primary" type="button" id="upbutton" title="<?php echo JText::_('COM_MEDIA_DIRECTORY_UP') ?>"><?php echo JText::_('COM_MEDIA_UP') ?></button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-xs-12 col-sm-4 padding25">
				...
				<button class="btn button-cancel btn-danger" type="button" onclick="window.parent.jQuery('.modal.in').modal('hide');parent.jModalClose();" data-dismiss="modal"><?php echo JText::_('JCANCEL') ?></button>
			</div>
		</div>
	</div>
	...
	<form action="<?php echo JUri::base(); ?>index.php?option=com_media&amp;task=file.upload&amp;tmpl=component&amp;<?php echo $this->session->getName() . '=' . $this->session->getId(); ?>&amp;<?php echo JSession::getFormToken();?>=1&amp;asset=<?php echo $input->getCmd('asset'); ?>&amp;author=<?php echo $input->getCmd('author'); ?>&amp;view=images" id="uploadForm" class="form-horizontal" name="uploadForm" method="post" enctype="multipart/form-data">
		<div id="uploadform" class="well">
			<fieldset id="upload-noflash" class="actions">
					<div class="row">
						<div class="col-xs-12">
							<label for="upload-file"><?php echo JText::_('COM_MEDIA_UPLOAD_FILE'); ?>
						</div>
					</div>
					<div class="row">
